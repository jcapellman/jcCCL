...
namespace jcCCL.PCL.Helpers {
    public class Security {
        ...
        public sealed class MD5Core {
            ...
            public static byte[] GetHash(string input) { return GetHash(input, new UTF8Encoding()); }
            ...
            public static Guid GetHashGuid(string input) {
                return new Guid(GetHashString(input));
            }

            public static string GetHashString(string input) { return GetHashString(input, new UTF8Encoding()); }
        ...
        */
            ...
            public static void GetHashBlock(byte[] input, ref ABCDStruct ABCDValue, int ibStart)
            {
            ...
            private static uint LSR(uint i, int s) { return ((i << s) | (i >> (32 - s))); }
